...
/**
 * shop_good_collectEntity
 * @author 高峰
 * @version 2021-02-16
 */
@Table(name="shop_good_collect", alias="a", columns={
...
public class ShopGoodCollect extends DataEntity<ShopGoodCollect> {
	...
	public ShopGoodCollect() {
		this(null);
	}

	public ShopGoodCollect(String id){
		super(id);
	}
