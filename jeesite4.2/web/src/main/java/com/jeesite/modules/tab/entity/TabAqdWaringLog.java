 ...
 * @version 2020-09-30
 */
@Table(name="tab_aqd_waring_log", alias="a", columns={
		...
		@Column(name="warning_type", attrName="warningType", label="报警类型"),
...
public class TabAqdWaringLog extends DataEntity<TabAqdWaringLog> {
	...
	public TabAqdWaringLog() {
		this(null);
	}

	public TabAqdWaringLog(String id){
		super(id);
	}
	...
	@Length(min=0, max=200, message="报警类型长度不能超过 200 个字符")
